...
<div className="px-2 sm:px-4">
      ...
      <section className="py-8 sm:py-12 lg:py-16">
        ...
        <div className="relative rounded-sm p-4 sm:p-12 bg-lightyellow">
          ...
          पूजन हो या पूजा, महोत्सव हो या महापूजा, वंदना हो या संवेदना, तमाम धर्मानुष्ठानों में भावों में वृद्धि का कार्य करने वाले चार फुट के कलश जैसी अनेक यूनिक सामग्री परिवार द्वारा संग्रहित की गई है। तथा सभी को बिना किसी मूल्य उपयोग करने के लिए उपलब्ध की जा रही है। आज तक इन सैकड़ों आइटम के संग्रह द्वारा लगभग ४०० अवसरों को शोभायमान किया है।
          </p>
        </div>
        </div>
      </section>
...
<CounterStatsUI statsData={statsData} textColor="maroon" />
    ...
    <CallToActionButton
                 heading="धर्मानुष्ठानों को आकर्षक बनाना चाहते हैं?"
                 content="पूजा, महापूजा और अनुष्ठानों को भावनात्मक एवं सौंदर्यपूर्ण बनाने के लिए हम कलश और अन्य सुशोभन सामग्री उपलब्ध कराते हैं।"
