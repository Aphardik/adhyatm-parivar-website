...
const JinalayaSuraksha = () => {
  ...
  return (
    <div className="bg-whitey max-w-7xl font-body text-darkblue">
      {/* Header */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="p-2 sm:p-4  mx-auto max-w-4xl">
            <div className="space-y-4">
              <p className="text-darkblue leading-relaxed text-center text-lg">
              ...
              <div className=" p-4 rounded-sm  border-b-2 border-darkblue/50 max-w-2xl mx-auto">
                <p className="text-darkblue font-semibold sm:text-xl font-base text-center">
      ...
      <section className="py-2 sm:py-4 lg:py-8 bg-whitey">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-shadeblue rounded p-6 sm:p-8">
            <div className="flex flex-col lg:flex-row gap-8 items-center">
              ...
              <div className="lg:w-4/5 space-y-4">
                <div className="relative border border-darkblue/20 p-6 sm:p-14 rounded-sm">
                  ...
                  <p className="text-darkblue sm:text-lg leading-relaxed">
                  ...
                  <p className="text-darkblue sm:text-lg leading-relaxed font-medium">
            ...
            <div className="mt-6 rounded p-4">
              <p className="text-darkblue text-lg font-semibold leading-relaxed text-center">
      ...
      <section className="py-6 sm:py-6 lg:py-8 ">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-shadeblue p-6 sm:p-8 ">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center gap-8 mb-8">
              ...
              <div className="flex flex-col items-center">
                <div className="bg-whitey text-darkblue w-12 h-12 rounded-full flex items-center justify-center font-bold text-lg ">
                  VS
                </div>
                <div className="text-darkblue text-sm mt-2 font-medium">
                  तुलना
                </div>
              </div>
            ...
            <div className="text-center">
              <div className="inline-flex items-center gap-2 bg-whitey text-darkblue px-6 py-3 rounded-full font-semibold">
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
                  viewBox="0 0 20 20"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-shadeblue rounded p-6 sm:p-8">
            <div className="text-center mb-8">
              <div className="text-2xl font-heading font-semibold text-darkblue mb-4">
            ...
            <div className="grid grid-cols-1  gap-6">
              <div className="space-y-4 ">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2  gap-6">
                  <div className="bg-shadeblue border relative border-darkblue/20 p-4 py-10 rounded-sm">
                    <div className="absolute top-0 left-0 opacity-15 group-hover:opacity-25 transition-opacity duration-300">
                      <TopLeftSvg />
                    </div>
                  ...
                  <div className="bg-shadeblue relative border border-darkblue/20 p-4 py-10 rounded-sm">
                    <div className="absolute top-0 left-0 opacity-15 group-hover:opacity-25 transition-opacity duration-300">
                      <TopLeftSvg />
                    </div>
                    <p className="text-darkblue leading-relaxed">
                  ...
                  <div className="bg-shadeblue relative border border-darkblue/20 p-4 py-10 rounded-sm">
                    ...
                    <p className="text-darkblue leading-relaxed font-medium">
      ...
      <section className="py-6 sm:py-6 lg:py-8 bg-whitey">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-whitey rounded p-0 sm:p-8 ">
            <div className="bg-shadeblue text-lg p-6 rounded-sm mb-6">
              <p className="text-darkblue text-xl font-bold mb-2">कार्य का आरंभ हुआ</p>
            ...
            <div className="grid grid-cols-1 text-lg lg:grid-cols-2 gap-6">
              <div className="bg-whitey p-6 rounded-sm space-y-6">
                ...
                <div className="relative bg-shadeblue p-4 sm:p-8 rounded-sm  ">
                  <div className="text-darkblue  text-center leading-relaxed font-medium text-xl">
                    <div className="absolute top-0 left-0 opacity-15 group-hover:opacity-25 transition-opacity duration-300">
        <TopLeftSvg />
      </div>
       <div className="absolute bottom-0 right-0 opacity-15 group-hover:opacity-25 transition-opacity duration-300">
        <BottomRighSvg />
              ...
              <div className="bg-shadeblue p-4 rounded-sm">
                <img
      ...
      <section className="py-6 sm:py-6 lg:py-8 bg-whitey">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-whitey rounded">
            <div className="mb-6">
              <p className="text-darkblue text-xl mb-4 leading-relaxed text-center">
              ...
              <p className="text-darkblue font-semibold text-xl leading-relaxed text-center">
