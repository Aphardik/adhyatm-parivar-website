...
const page = () => {
  return (
        <div class="mx-auto py-4 font-body">
      <div class="flex items-center gap-4">
        <div class="bg-gray-800 text-white text-4xl font-bold p-4 inline-block">
          2.5
        </div>
        <div>
          <h1 class="text-gray-800 font-heading text-2xl font-bold mt-4">
            देवबगीचे का निर्माण
          </h1>
          <p class="text-gray-500">(कार्य प्रारंभ : वि.सं.२०७७)</p>
        </div>
      </div>
      ...
      <div class="flex flex-col md:flex-row justify-around items-center mt-8">
        <div class="text-center mb-4 md:mb-0">
          <p class="text-gray-600">यह है जूनागढ़ देवबगीचा</p>
          <img
        ...
        <div class="text-center mb-4 md:mb-0">
          <p class="text-gray-600">खंभात में देवबगीचे का प्रारंभ</p>
          <img
