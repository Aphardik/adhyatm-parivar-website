...
const Page = () => {
    ...
    { count: "14Cr +", label: "प्रभुपूजको द्वारा ख़रीदे गए द्रव्यों की कुल कीमत",color: "bg-gradient-to-b from-green-400 to-green-600" },
    ...
    <div className="container bg-background mx-auto font-body">
      ...
      <section className="my-12">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12 items-center">
          ...
          <div className="bg-lighten-bg rounded-lg p-6 shadow-sm order-1 md:order-2">
            <img
              ...
              className="w-full h-64 object-contain rounded-lg  transition-transform transform hover:scale-105"
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12 items-center">
          <div className="bg-lighten-bg rounded-lg p-6 shadow-sm text-center">
            <img
              src="/adhyatm/suddh-puja-dravya/img-3.37.png"
              alt="Bheemseti Kapoor"
              className="mx-auto mb-4 rounded-full h-64 object-contain"
            />
          ...
          <div className="bg-lighten-bg rounded-lg p-6 shadow-sm text-center">
            <img
              src="/adhyatm/suddh-puja-dravya/img-3.38.png"
