    ...
    <div className="bg-background text-heading font-body">
      ...
      <header className="bg-light-bg">
        <div className="mx-auto p-4 sm:p-6 lg:py-8">
          <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-start gap-4 sm:gap-6 lg:gap-8">
            <div className="bg-lighten-bg text-heading text-2xl sm:text-4xl font-bold font-heading px-4 py-3 sm:px-6 sm:py-4 lg:px-8 lg:py-6 min-w-fit rounded-sm">
              1.1
            </div>
      ...
      <section className="py-8 sm:py-12 lg:py-16">
        <div className="mx-auto px-4 sm:px-6 max-w-6xl">
          ...
          <div className="bg-background rounded-sm shadow-lg p-6 sm:p-8 lg:p-10">
      ...
      <section className="py-8 sm:py-12 lg:py-16 bg-lighten-bg">
        <div className="mx-auto px-4 sm:px-6 max-w-7xl">
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="order-2 lg:order-1">
                <div className="bg-background rounded-sm shadow-lg overflow-hidden">
                  <img src="/jinmurti/jinpratima-suraksha/img-1.1.png" alt="Damaged Statue" className="w-full h-64 sm:h-80 object-cover" />
                </div>
              </div>
              <div className="order-1 lg:order-2 bg-background rounded-sm shadow-lg p-6 sm:p-8">
                <h3 className="text-xl sm:text-2xl font-bold text-heading mb-4">कड़वी वास्तविकता</h3>
          ...
          <div className="mb-12 lg:mb-16">
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="bg-background rounded-sm shadow-lg p-6 sm:p-8">
                <h3 className="text-xl sm:text-2xl font-bold text-heading mb-4">प्रभु के चरणों की दुर्दशा</h3>
                ...
                <p className="text-content text-base sm:text-lg leading-relaxed">
                  उन प्रभु के चरणों पर चिपकाये हुए पंजे से पैदा होने वाली दर्दनाक दुर्दशा!
                </p>
              </div>
              <div className="bg-background rounded-sm shadow-lg overflow-hidden">
                <img src="/jinmurti/jinpratima-suraksha/img-1.2.png" alt="Damaged Feet" className="w-full h-64 sm:h-80 object-cover" />
              </div>
            </div>
          </div>
          ...
          <div className="mb-12 lg:mb-16">
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="order-2 lg:order-1">
                <div className="bg-background rounded-sm shadow-lg overflow-hidden">
                  <img src="/jinmurti/jinpratima-suraksha/img-1.3.png" alt="Damaged Parts" className="w-full h-64 sm:h-80 object-cover" />
                </div>
              </div>
              <div className="order-1 lg:order-2 bg-background rounded-sm shadow-lg p-6 sm:p-8">
                <h3 className="text-xl sm:text-2xl font-bold text-heading mb-4">नमी का कारण</h3>
                <p className="text-lg sm:text-xl text-heading leading-relaxed">
          ...
          <div className="mb-12 lg:mb-16">
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="bg-background rounded-sm shadow-lg p-6 sm:p-8">
                <h3 className="text-xl sm:text-2xl font-bold text-heading mb-4">धरणेंद्र की सुरक्षा</h3>
                <p className="text-lg sm:text-xl text-heading mb-4 leading-relaxed">
                  पार्श्वनाथ प्रभु को तो धरणेंद्रने सुरक्षित रखा था।
                </p>
                <p className="text-content text-base sm:text-lg italic leading-relaxed">
                  हम प्रभु के प्रतिबिंब रूपी फणा को नहीं संभाल सके!
                </p>
              </div>
              <div className="bg-background rounded-sm shadow-lg overflow-hidden">
                <img src="/jinmurti/jinpratima-suraksha/img-1.4.png" alt="Damaged Parts" className="w-full h-64 sm:h-80 object-cover" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-8 sm:py-12 lg:py-16 bg-background">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mb-8 lg:mb-12">
            ...
            <div className="bg-lighten-bg rounded-sm shadow-lg p-6 sm:p-8">
              <p className="text-heading text-lg sm:text-xl mb-6 font-medium text-center">
              ...
              <div className="bg-lighten-bg flex items-center justify-center p-6 sm:p-8 rounded-sm">
                <p className="text-heading font-semibold flex items-center justify-center gap-4 text-xl sm:text-2xl italic text-center">
                  <FaQuoteLeft size={32} className="text-content flex-shrink-0" /> 
                  प्रतिमा पर जिस जगह पर जरा भी पानी रह जाता है (वहां) श्यामलता आ जाती है। 
                  <FaQuoteRight size={32} className="text-content flex-shrink-0" />
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Root Cause Analysis */}
          <div className="bg-lighten-bg rounded-sm shadow-lg p-6 sm:p-8 lg:p-10">
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div>
                <h3 className="text-xl sm:text-2xl font-bold mb-6 text-heading">
                  बबूल के पेड़ की जड़ के बदले मात्रा डालियां कांटने से कांटे चुभना किस प्रकार बंद होंगे?
                </h3>
                <div className="space-y-4">
                  <div className="flex gap-4 items-start">
                    <span className="w-8 h-8 bg-secondary-color text-background rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0">1</span>
                    <span className="font-medium text-lg">सबसे पहले १ इंच का टिका लगाया गया उसके गड्ढ़े!</span>
                  </div>
                  <div className="flex gap-4 items-start">
                    <span className="w-8 h-8 bg-secondary-color text-background rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0">2</span>
                    <span className="font-medium text-lg">उसको ढकने १.५ इंच का टिका लगाया उससे दूसरा गड्ढ़ा हुआ!</span>
                  </div>
                  <div className="flex gap-4 items-start">
                    <span className="w-8 h-8 bg-secondary-color text-background rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0">3</span>
                    <span className="font-medium text-lg">इन दोनों को छिपाने के २ इंच का टिका लगाया उससे बना तीसरा गड्ढ़ा!</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-8 sm:py-12 lg:py-16 bg-lighten-bg">
        <div className="mx-auto  max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            <div className="bg-background rounded-sm shadow-lg p-6 sm:p-8">
              <h3 className="text-xl sm:text-2xl font-bold mb-4 text-heading">प्रत्येक पूजक का एक संकल्प:</h3>
              <div className=" rounded-sm p-4 sm:p-6 space-y-3">
                <p className="font-medium text-lg text-content">'शासन की धरोहर की सुरक्षा के लिए रोज १ मिनट अर्पण करूंगा'।</p>
                <p className="font-medium text-lg text-content">मै अंगलुंछ्ने से अपने प्रभु को सूखा कर ही पूजा करूंगा।</p>
              </div>
            </div>
            <div className="bg-background rounded-sm shadow-lg p-6 sm:p-8">
              <h3 className="text-xl sm:text-2xl font-bold mb-4 text-heading">भविष्य का नुकसान रुकेगा:</h3>
              <div className=" rounded-sm p-4 sm:p-6 space-y-3">
                ...
                <p className="font-medium text-content text-base sm:text-lg">मै अंगलुंछ्ने से अपने प्रभु को सूखा कर ही पूजा करूंगा।</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-8 sm:py-12 lg:py-16 bg-background">
        <div className="mx-auto  max-w-7xl">
          ...
          <div className="bg-lighten-bg rounded-sm shadow-lg p-6 sm:p-8 lg:p-10 mb-8 lg:mb-12">
            <p className="text-center text-heading text-lg sm:text-xl leading-relaxed">
          ...
          {/* Recent Work Done */}
          <div className="bg-lighten-bg rounded-sm shadow-lg overflow-hidden mb-8 lg:mb-12">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-8 lg:mb-12">
            {/* Card 1 */}
            <div className="bg-background rounded-sm shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                <h4 className="font-semibold text-xl mb-3 text-heading">
            ...
            {/* Card 3 */}
            <div className="bg-background rounded-sm shadow-lg overflow-hidden hover:shadow-xl transition-shadow sm:col-span-2 lg:col-span-1">
              <div className="h-48 sm:h-56 bg-lighten-bg flex items-center justify-center">
                <img 
              ...
              <div className="p-6">
                <h4 className="font-bold text-xl mb-3 text-heading">
        ...
        <div className="bg-background text-background py-4 sm:py-8">
          <div className="mx-auto">
            ...
            <h2 className="text-xl inline sm:text-2xl lg:text-3xl font-semibold font-heading bg-secondary-color text-background  px-4 py-3 sm:px-6 sm:py-4 lg:px-8">
