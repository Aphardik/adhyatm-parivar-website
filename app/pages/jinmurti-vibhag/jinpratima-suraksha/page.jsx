...
//               <h1 className="text-2xl sm:text-4xl font-heading font-bold text-[#FDD2DB] mb-1 sm:mb-2">
//                 जिनप्रतिमा सुरक्षा
//               </h1>
//               <p className="sm:text-base lg:text-lg text-[#FDD2DB] font-medium">
...
//             <h2 className="text-xl sm:text-2xl lg:text-3xl font-semibold font-heading bg-[#01044c]  text-[#FDD2DB] inline-block px-6 py-3 sm:px-8 sm:py-4 rounded-sm">
...
//             <div className="text-center mb-8 lg:mb-12">
//               <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold font-heading bg-[#01044c]  text-[#FDD2DB] inline-block px-6 py-3 sm:px-8 sm:py-4 rounded-sm">
//                 महत्वपूर्ण निष्कर्ष
//               </h3>
//             </div>
...
//                     <span className="w-8 h-8 bg-[#01044c]  text-[#FDD2DB] rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0">
//                       1
//                     </span>
...
//             <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold font-heading bg-[#01044c]  text-[#FDD2DB] inline-block px-6 py-3 sm:px-8 sm:py-4 rounded-sm">
...
//             <div className="inline-block bg-[#01044c]  text-[#FDD2DB] px-8 py-4 rounded-sm ">
...
//                   </h3>
//                   <div className=" h-48 flex items-center justify-center rounded-lg mb-4">
//                     <img
                ...
                <div className="grid grid-cols-12 gap-4 sm:gap-6 max-w-7xl mx-auto items-center">
                  ...
                  <div className="col-span-12 flex items-center justify-center lg:col-span-4">
                    <div className="text-center lg:text-left">
                      <Link
                        href="https://wa.me/918448444050?text=नमस्कार%2C%0A%0Aमैं%20अध्यात्म%20परिवार%20की%20सेवाओं%20के%20बारे%20में%20जानकारी%20चाहता%2Fचाहती%20हूं।%20कृपया%20प्रतिमाजी%20की%20शुद्धि-सुरक्षा%20के%20लिए%20उपलब्ध%20सेवाओं%20की%20विस्तृत%20जानकारी%20प्रदान%20करें।%0A%0Aधन्यवाद"
                        target="_blank"
