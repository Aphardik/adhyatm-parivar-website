...
const EventPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br font-anek from-slate-50 to-blue-50">
      {/* Hero Section */}
       ...
       <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden mb-12">
          <div className="bg-gradient2 p-4 px-8 pt-6 text-center">
            <div className="flex items-center justify-center mb-4">
              <h2 className="text-3xl font-bold">અપચય પાતળ્લા યોગ્ય નિયમો</h2>
            </div>
          </div>
          ...
          <div className="p-8 bg-gradient-to-br from-gray-50 to-orange-50">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
              {rules.map((rule, index) => (
                <div key={index} className="bg-white p-6 rounded-2xl shadow-md border-l-4 border-darkpink hover:shadow-lg transition-all duration-300 h-full flex flex-col">
            ...
            <div className="mt-8 pt-8 border-t-2 border-gray-200">
              <div className="bg-gradient2 p-6 rounded-2xl shadow-lg">
                <h1 className='font-bold text-2xl md:text-3xl text-center text-gray-800'>
                  આયોજક : અધ્યાત્મ પરિવાર - 844 844 40 50
                </h1>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white max-w-5xl mx-auto rounded-3xl shadow-lg border border-gray-100 overflow-hidden group hover:shadow-2xl transition-all duration-300 mb-12">
          <div className="bg-gradient2 p-6">
            <h3 className="text-2xl font-bold flex items-center">
              ...
              ઉપધાન સ્થળ : પુષ્પાંજલિ ગાર્ડન્સ,ચંદાવરકર રોડ, બોરીવલી (વે), મુંબઈ
            </h3>
          </div>
