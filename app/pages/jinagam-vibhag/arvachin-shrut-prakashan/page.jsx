  ...
  return (
    <div className="mx-auto max-w-7xl font-body bg-whitey">
        ...
        <div className="mx-auto p-4 sm:p-6 lg:py-8">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 lg:gap-8">
            <div className="text-center sm:text-left">
              ...
              <p className="text-base lg:text-lg text-maroon font-medium mb-1 sm:mb-2">
      ...
      <div className="px-2 sm:px-4">
        {/* Main Content */}
        <section className="py-4 max-w-4xl mx-auto sm:py-6 lg:py-8 lg:px-0">
          <div className="relative rounded-xl p-4 sm:p-12 bg-lightyellow">
            ...
            <div className="grid grid-cols-1 gap-4">
              {bulletPoints.map((point, index) => (
                <p key={index} className="text-lg leading-relaxed text-maroon">
                  • {point}
                </p>
              ))}
            </div>
