...
const MembershipForm = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b font-sans from-indigo-50 to-white py-8 px-2 sm:px-6 lg:px-8">
      <div className="w-full relative mx-auto max-w-7xl">

        {/* Logo positioned centered on small screens, top-left on larger screens */}
        {/* <div className="absolute !left-10   transform -translate-x-1/2 sm:left-0 sm:top-0 sm:transform-none z-10">
      <div className="w-14 sm:w-16 ">
        ...
        <div className="">
          ...
          {/* Header Section */}
          <div className="flex gap-4 font-sans mt-16 sm:mt-0 items-start justify-center">
              ...
              {steps.map((step, i) => (
                <React.Fragment key={step.id}>
                  ...
                  ${getStepStatus(step.id) === "completed"
                    ...
                    <div
                      key={step.id}
                      className={`text-center ${getStepStatus(step.id) !== "upcoming"
                          ? "text-gray-700 font-medium"
                          : "text-gray-500"
                        }`}
                    >
                      <span className="text-sm font-sans">{step.title}</span>
                    </div>
                  </div>
              ...
              <div className="flex items-center justify-between mb-3">
                {steps.map((step, i) => (
                  ...
                  ${getStepStatus(step.id) === "completed"
                    ...
                    <div className="mt-2">
                      <span
                        className={`text-xs font-medium ${getStepStatus(step.id) === "completed" || getStepStatus(step.id) === "current"
                            ? "text-green-600"
                            : "text-gray-400"
                          }`}
                      >
          ...
          <div className="flex justify-center">
            <div className="bg-white w-full sm:w-[60vw] max-w-4xl shadow-lg rounded-xl mb-8 border border-indigo-100 transform transition-all duration-300">
              <div className="mb-6 p-3 bg-gray-800 border-b border-gray-300">
                <h2 className="text-base font-sans font-medium text-gray-200 flex items-center">
