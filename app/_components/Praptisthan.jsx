...
import { BiBuilding, BiLocationPlus, BiMapPin, BiPhone, BiSearch } from 'react-icons/bi';
...
const PratisthanDirectory = () => {
  ...
  const PratisthanCard = ({ entry }) => (
    <div className="bg-white shadow-md hover:shadow-lg border border-gray-300 p-6 font-body hover:bg-gray-50 transition-colors">
    ...
    <div className="min-h-screen py-8">
      ...
      <div className="bg-gray-100 border shadow-md border-gray-300 sticky mb-8 top-16 z-10">
        <div className="max-w-7xl flex flex-col gap-2 sm:gap-0 sm:flex-row items-center justify-between mx-auto px-4 py-6">
          <h1 className="text-2xl flex items-center justify-center gap-2 font-heading font-bold text-gray-800 text-center">
           <IoLocation/> <span>शुद्धद्रव्य प्राप्तिस्थान</span>
          </h1>
          ...
          <div className="relative w-full max-w-3xl rounded-3xl">
            ...
            <input
              ...
              className="w-full placeholder:font-body bg-white placeholder:text-gray-400 pl-10 pr-4 py-2 text-lg border rounded-4xl border-gray-300 focus:outline-none focus:ring-2 focus:ring-cyan-700/60 focus:border-gray-400"
              value={searchTerm}
