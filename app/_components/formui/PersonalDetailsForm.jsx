...
const PersonalDetailsForm = ({ formData, updateFormData, nextStep }) => {
    ...
    try {
      ...
      if (values.photo && values.photo.length > 0) {
        ...
        const storageRef = ref(
          storage,
          `apmemebershipform/${values.name}_profile_${file.name}`
        );
      ...
      if (values.aadhaarPhoto && values.aadhaarPhoto.length > 0) {
        const file = values.aadhaarPhoto[0].originFileObj;
        const storageRef = ref(
          storage,
          `apmemebershipform/${values.name}_aadhaar_${file.name}`
        );
        const uploadTask = uploadBytesResumable(storageRef, file);
        ...
        await new Promise((resolve, reject) => {
          uploadTask.on(
            ...
            (snapshot) => {},
            (error) => {
              message.error("Aadhaar upload failed.");
              reject(error);
            },
            async () => {
              aadhaarUrl = await getDownloadURL(uploadTask.snapshot.ref);
              resolve();
            }
          );
        });
      ...
      <div className="w-full px-4 md:px-20 pb-6">
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-2">
            ...
            <Form.Item
              className="!font-body"
              label={<span className="font-body text-base">प्रथम नाम</span>}
              name="name"
              rules={requiredField("कृपया अपना प्रथम नाम दर्ज करें!")}
            >
              <Input
                className="!py-2 !font-body"
                placeholder="आपका प्रथम नाम दर्ज करें"
              />
            </Form.Item>

            <Form.Item
              label={<span className="font-body text-base">मध्य नाम</span>}
              name="middleName"
            >
              <Input
                className="!py-2 !font-body"
                placeholder="आपका मध्य नाम दर्ज करें"
              />
            </Form.Item>

            <Form.Item
              label={<span className="font-body text-base">अटक/सरनेम </span>}
              name="surname"
              rules={requiredField("कृपया अपना अटक/सरनेम  दर्ज करें!")}
            >
              <Input
                className="!py-2 !font-body"
                placeholder="आपका अटक/सरनेम दर्ज करें"
              />
            </Form.Item>
            ...
            <Form.Item
              label={
                <div className="flex items-center">
                  <span className="font-body text-base">प्रचलित नाम</span>
                  <Tooltip
            ...
            <Form.Item
              label={<span className="font-body text-base">संपर्क नंबर</span>}
              name="contact"
            ...
            <Form.Item
              label={<span className="font-body text-base">ईमेल</span>}
              name="email"
              className="sm:col-span-2"
            >
              <Input
                className="!py-2 sm:col-span-2 !font-body"
                placeholder="आपका ईमेल पता दर्ज करें"
              />
            </Form.Item>

            <Form.Item
              label={<span className="font-body text-base">जन्म तिथि</span>}
              name="birthTithi"
              rules={requiredField("कृपया अपनी जन्म तिथि दर्ज करें!")}
            >
              <Input
                className="!py-2 w-full !font-body"
                placeholder="जन्म तिथि दर्ज करें"
              />
            </Form.Item>
            <Form.Item
              label={<span className="font-body text-base">जन्म तारीख</span>}
              name="birthDate"
            ...
            <Form.Item
              ...
              label={<span className="font-body text-base">घर का पता</span>}
              name="homeAddress"
            >
              <Input className="!py-2 !font-body" placeholder="घर का पता भरे" />
            </Form.Item>

            <Form.Item
              label={<span className="font-body text-base">एरिया</span>}
              name="area"
            >
              <Input className="!py-2 !font-body" placeholder="एरिया भरे" />
            </Form.Item>

            <Form.Item
              label={<span className="font-body text-base">लैंडमार्क</span>}
              name="landmark"
            >
              <Input className="!py-2 !font-body" placeholder="लैंडमार्क भरे" />
            </Form.Item>

            <Form.Item
              rules={requiredField("कृपया शहर दर्ज करें!")}
              label={<span className="font-body text-base">शहर/गाँव</span>}
              name="city"
            >
              <Input className="!py-2 !font-body" placeholder="शहर चुनें" />
            </Form.Item>

            <Form.Item
              rules={requiredField("कृपया राज्य दर्ज करें!")}
              label={<span className="font-body text-base">राज्य</span>}
              name="state"
            >
            ...
            <Form.Item
              ...
              label={<span className="font-body text-base">देश</span>}
              name="country"
              initialValue="India"
            >
            ...
            <Form.Item
              ...
              label={<span className="font-body text-base">पिनकोड</span>}
              name="pincode"
              className=""
            >
              <Input
                className="!py-2 !font-body sm:col-span-2"
            ...
            <Form.Item
              ...
              label={<span className="font-body text-base">मूलवतन</span>}
              name="hometown"
            >
              <Input className="!py-2 !font-body" placeholder="मूलवतन भरे" />
            </Form.Item>
            ...
            <Form.Item
              label={
                <span className="font-body text-base">धार्मिक अभ्यास</span>
              }
            ...
            >
              <Input
                className="!py-2 !font-body"
                placeholder="धार्मिक अभ्यास दर्ज करें"
              />
            </Form.Item>

            <Form.Item
              label={
                <span className="font-body text-base">व्यवहारिक अभ्यास</span>
              }
            ...
            <Form.Item
              label={
                <span className="font-body text-base">निवृत्त/जॉब/बिजनेस</span>
              }
              name="job"
            ...
            <Form.Item
              label={
                <span className="font-body text-base">वैवाहिक स्थिति</span>
              }
              name="maritialStatus"
            ...
            <Form.Item
              label={<span className="font-body text-base">समाज</span>}
              name="samaj"
              rules={requiredField("कृपया समाज का नाम दर्ज करें!")}
            >
              <Input
                placeholder="समाज का नाम भरे"
                className="!py-2 !font-body"
              />
            </Form.Item>
            ...
            {isOtherOrganizationMember && (
              <div className="border mb-6 bg-gray-50 p-6 border-gray-200">
                {isOtherOrganizationMember && (
                  <Form.Item
                    label={
                      <span className="font-body text-base">संस्था का नाम</span>
                    }
                ...
                {isOtherOrganizationMember && (
                  <Form.Item
                    label={
                      <span className="font-body text-base">संस्था का पता</span>
                    }
                    name="sansthaAddress"
                    className="sm:col-span-2"
                ...
                {isDesignatedSansthaMember && (
                  <Form.Item
                    label={
                      <span className="font-body text-base">पद का नाम</span>
                    }
            ...
            {isOtherSanghMember && (
              <div className="border bg-gray-50 p-6 mb-6 border-gray-200">
                {isOtherSanghMember && (
                  <Form.Item
                    label={
                      <span className="font-body text-base">संघ का नाम</span>
                    }
                    name="sanghName"
                    className="sm:col-span-2"
                ...
                {isOtherSanghMember && (
                  <Form.Item
                    label={
                      <span className="font-body text-base">संघ का पता</span>
                    }
                    name="sanghAddress"
                    className="sm:col-span-2"
            ...
            {isFamilyInGovtService && (
              <div className="border bg-gray-50 p-6 mb-6 border-gray-200">
                <Form.Item
                  label={
                    <span className="font-body text-base">सदस्य का नाम</span>
                  }
                  name="govtMemberName"
                  className="sm:col-span-2"
            ...
            {selectedLanguages.includes("other") && (
              ...
              >
                <Input
                  className="!font-body"
                  placeholder="यहाँ अन्य भाषा लिखें"
                />
              </Form.Item>
            )}
            <Form.Item
              label={
                <span className="font-body text-base">फोटो अपलोड करें</span>
              }
              name="photo"
            ...
            >
              <Dragger {...photoUploadProps} className="p-4">
                ...
                <p className="ant-upload-text font-body text-base">
                  फाइल ड्रैग करें या{" "}
  ...
  getValueFromEvent={normFile}
  className="sm:col-span-2"
  rules={requiredField("कृपया आधार कार्ड की फोटो अपलोड करें!")}
>
  <Upload.Dragger
    maxCount={1}
    listType="picture"
    beforeUpload={(file) => {
      const isJpgOrPng =
        ...
        file.type === "image/pdf" ;
      if (!isJpgOrPng) {
        message.error("केवल JPG/PNG/PDF फाइल अपलोड करें!");
      }
      const isLt5M = file.size / 1024 / 1024 < 5;
      if (!isLt5M) {
        message.error("फोटो 5MB से छोटी होनी चाहिए!");
      }
  ...
  >
    ...
    <p className="ant-upload-hint text-xs text-gray-500">
      समर्थित प्रारूप: JPEG, PNG, PDF | अधिकतम आकार: 5MB
    </p>
  </Upload.Dragger>
</Form.Item>
          ...
          <div className="flex mt-8 justify-end items-center">
            <button
              ...
              className={`flex items-center px-4 py-2 rounded-sm font-medium shadow-md transition-all duration-300 ${
                isProcessing
                  ? "bg-gray-400 text-gray-200 cursor-not-allowed"
                  : "bg-gray-800 text-gray-100 hover:bg-gray-900 hover:shadow-lg"
              }`}
            >
              {isProcessing ? (
                <>
