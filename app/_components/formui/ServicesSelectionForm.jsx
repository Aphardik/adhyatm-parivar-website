...
const DEPARTMENTS = [
  {
    ...
    services: [
      ...
      {
        id: 107,
        name: "उत्तम द्रव्य संशोधन एवं प्राप्ति",
        description:
          "जिनप्रतिमा शुद्धि-सुरक्षा-अभिषेक आदि हेतु परिवार के मार्गदर्शन से उत्तम द्रव्यों का संशोधन एवं उन्हें प्राप्त करना",
      },
    ],
  },
  {
...
const ServiceStep = ({ formData, updateFormData, nextStep, prevStep }) => {
  ...
  return (
    <div className="relative w-full flex-col font-body flex justify-center">
      {contextHolder}
      <div className="w-full px-5 md:px-20 pb-6">
        ...
        >
              ...
              {DEPARTMENTS.map((department) => (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <div className="flex font-body flex-col space-y-3">
          ...
          <div className="border-b pb-4">
            <p className="text-base font-body pt-8 pb-2">
              ...
              <div className="flex  items-center">
                ...
                {isDailyChecked && (
                  <div className="ml-6 flex items-center">
                    <span className="mr-2 font-body">कितने घंटे</span>
            ...
            <Form.Item
              label={
                <span className="font-body text-base mt-4">
            ...
            <Form.Item
              label={
                <span className="font-body mt-4 text-base">
