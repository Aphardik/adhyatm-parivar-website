        ...
        <div className="col-span-12 flex items-center justify-center lg:col-span-4">
          <div className="text-center lg:text-left">
            <Link
              ...
              className="bg-whitey text-maroon font-bold py-3 px-8 rounded-4xl shadow-sm transition-all duration-300 transform hover:shadow-xl text-lg inline-flex items-center gap-2"
            >
