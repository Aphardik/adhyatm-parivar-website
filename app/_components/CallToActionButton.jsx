...
const CallToActionButton = ({heading,content,id,href}) => {
  return (
    <div className="bg-gradient-to-r rounded-md from-maroon to-maroon/80 text-whitey shadow-lg hover:shadow-xl transition-shadow duration-300 relative overflow-hidden p-8 sm:p-12">
      {/* Header */}
     <HexagonalSvg accentColor="rgba(255,255,255,0.1)"/>
      ...
      <div className="grid grid-cols-12 gap-4 sm:gap-6 max-w-7xl mx-auto items-center relative z-10">
       ...
       {heading}
          ...
          {content && <div className=" rounded-lg p-4 sm:p-6  border-yellow-200">
