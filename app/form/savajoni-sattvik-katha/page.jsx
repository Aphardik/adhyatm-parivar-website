...
const ImageCarousel = () => {
  ...
  const images = ["/bookimages/savjonisatvikkatha1.webp","/bookimages/savjonisatvikkatha2.webp"];
...
export default function SavjoniSattvikKathaForm() {
  ...
  const onFinish = async (values) => {
    ...
    try {
      ...
      const response = await axios.post(
        ...
        "https://universalform-fahifz22ha-uc.a.run.app?form=savjonisattvikkatha",
        values
      );
  ...
  return (
     <div className="min-h-screen w-full flex flex-col items-center justify-center py-0 md:py-8 bg-gray-100">
        ...
        <div className="inline-block">
          <h1 className="font-anek  text-2xl mt-6 pt-2 sm:mt-0 sm:pt-3 sm:text-3xl lg:text-4xl font-bold mb-2 sm:mb-4 bg-gradient-to-r from-orange-600 to-amber-600 bg-clip-text text-transparent">
...
//   const images = ["/bookimages/savjonisatvikkatha1.jpg","/bookimages/savjonisatvikkatha2.jpg"];
...
//                   <p className="text-gray-200 font-anek font-bold text-xl leading-relaxed">
//                     આ પુસ્તકનો સ્ટોક પૂર્ણ થયેલ છે,
//                     <br />
