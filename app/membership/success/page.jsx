...
const Success = () => {
  ...
  return (
    <div className="flex items-center w-screen font-Anek justify-center min-h-screen bg-gray-50">
      <div className="relative border border-gray-300 border-t-2 bg-white rounded-lg shadow-lg p-8 max-w-md text-center">
        {/* Icon positioned at the top center */}
        <div className="absolute -top-8 left-1/2 transform -translate-x-1/2">
          <FaCheckCircle size={80} className="text-green-700 bg-white rounded-full p-1" />
        </div>
        ...
        <button 
          onClick={() => router.push("/")} 
          className="mt-6 w-full bg-green-700 text-white px-4 py-2 rounded hover:bg-green-600 transition-colors"
        >
          Ok
        </button>
      </div>
